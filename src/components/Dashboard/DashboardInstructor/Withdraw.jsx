        ...
        <div>
            ...
            >
                <section className='mx-72 min-h-screen my-20'>
                    <h2 className='text-3xl text-center uppercase'>Withdraw Request</h2>
                    <form onSubmit={handleSubmit(onSubmit)} className="p-8 bg-white rounded shadow-md">
                        ...
                        <label className="block mb-2 font-bold" htmlFor="price">Request Amount</label>
                        <div className="mb-4 shadow-lg">
                            <input type="number" step="0.01" {...register('price', { required: true })} className="w-full px-4 py-2 border rounded" />
                            {errors.price && <span className="text-red-500">This field is required</span>}
                        </div>

                        <button type="submit" disabled={disabled} className="btn text-white  bg-green-500 hover:bg-green-600">Request</button>
                    </form>
                </section>
            </motion.div>
        </div>
