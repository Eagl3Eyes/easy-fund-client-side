...
const ContactUs = () => {
  ...
  return (
    <>
      <section className="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10 lg:ml-44 ml-6">
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white bg-slate-600 transition border rounded me-3 mb-2 hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
