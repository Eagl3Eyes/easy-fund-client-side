...
const Footer = ({ toggle }) => {
    return (
        <>
            <footer className={`footer p-10 bg-base-200 text-base-content  ${toggle ? 'bg-base-200' : 'bg-slate-500 text-white'}`}>
                <div className='grid justify-items-center'>
                    <img src="https://i.ibb.co/ynwZBxh/logo.png"
                        className="w-10 inline" />
                    <p>Art & School</p>
                    <p>Providing reliable Education since 2023</p>
                    <p>Phone: 01901234567</p>
